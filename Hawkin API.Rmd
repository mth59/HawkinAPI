...
# covariance & correlation matrix for numeric columns
cov_matrix_numeric <- cov(data_numeric)
cor_matrix_numeric <- cor(data_numeric)

# extract covariances & correlations related to the column jump_height_m
...
cov_cor_df <- data.frame(
  Metric = metric_names,
  Covariance = cov_with_jump_height,
  Correlation = cor_with_jump_height
)

write_xlsx(cov_cor_df, path = "Covariances and Correlations to Jump Height.xlsx")
